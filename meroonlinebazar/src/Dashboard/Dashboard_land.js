...
class Dashboard_land extends Component{
	constructor(props) {
        super(props);
        // this.user= getUser();
	...
	DeletePost(id, e){
		...
		fetch(`https://djangowithreactjs.herokuapp.com/addpost_land/${id}/`, {
  ...
  let user=getUser()
        ...
        axios.get( `https://appwithdjangoandreact.herokuapp.com/land/${user}`) 
        .then(res => { 
