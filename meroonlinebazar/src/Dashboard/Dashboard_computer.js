...
class Dashboard_computer extends Component{
	constructor(props) {
        super(props);
        // this.user= getUser();
	...
	DeletePost(id, e){
		...
		fetch(`https://djangowithreactjs.herokuapp.com/addpost_computer/${id}/`, {
				...
				// window.open("/dashboard_computer");
  ...
  let user=getUser()
        ...
        axios.get( `https://appwithdjangoandreact.herokuapp.com/computer/${user}`) 
        .then(res => { 
...
export default Dashboard_computer;