...
class Dashboard_phones extends Component{
	constructor(props) {
        super(props);
        // this.user= getUser();
	...
	DeletePost(id, e){
		...
		fetch(`https://djangowithreactjs.herokuapp.com/addpost_phones/${id}/`, {
  ...
  let user=getUser()
        ...
        axios.get( `https://appwithdjangoandreact.herokuapp.com/phones/${user}`) 
        .then(res => { 
...
export default Dashboard_phones;